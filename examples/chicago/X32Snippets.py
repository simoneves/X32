...
FIRST_DCA_COL          = 20     # spreadsheet column of data for first DCA
NUM_DCAS               = 8      # number of DCAs
DCA_COLOR              = 'WH'   # color for active DCA labels

# Craig Flint warn upcoming DCAs
CF_WARN_DCAS           = False  # show next cue's active DCAs
...
SE_BAND_MUTES          = False  # mute one or more band channel per cue, all others will be unmuted (e.g. for switching basses)
